...
# =============== PROCEDURE ================= #
	...
	BEGIN
		...
		SELECT `AUTO_INCREMENT` INTO id_param 
			...
			WHERE TABLE_SCHEMA = 'lordraze_scm_shb' AND TABLE_NAME = 'supplier';
	...
	BEGIN
		...
		SELECT `AUTO_INCREMENT` INTO id_param 
	    FROM INFORMATION_SCHEMA.TABLES 
	    WHERE TABLE_SCHEMA = 'lordraze_scm_shb' AND TABLE_NAME = 'bahan_baku';
	...
	BEGIN
		...
		SELECT `AUTO_INCREMENT` INTO id_param 
	    FROM INFORMATION_SCHEMA.TABLES 
	    WHERE TABLE_SCHEMA = 'lordraze_scm_shb' AND TABLE_NAME = 'produk';
