    	 		...
    	 		<div class="panel-wrapper collapse in">
    	 			<div class="panel-body">
    	 				...
    	 				<div class="row">
    	 					<div class="col-md-12 col-lg-12 col-sm-12 col-xs-12">
    	 						<div class="btn-group m-b-30">
    	 							<button id="tambah_transportasi" class="fcbtn btn btn-info btn-outline waves-effect waves-light btn-1b" data-toggle="tooltip" data-placement="top" title="Tambah Data"><i class="fa fa-plus"></i> Tambah</button>
    	 				...
    	 				<div class="table-responsive">
    	 					<table id="tabel_transportasi" class="table table-hover dt-responsive nowrap" cellspacing="0" width="100%">
	    	 					<thead>
	    	 						<tr>
...
<!-- js list -->
<script type="text/javascript" src="<?= base_url."app/views/transportasi/js/initList.js"; ?>"></script>
<!-- js form modal -->
<script type="text/javascript" src="<?= base_url."app/views/transportasi/js/initForm.js"; ?>"></script>