...
<div class="row bg-title">
    <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
        <h4 class="page-title">Data Mutasi Bahan Baku</h4>
    </div>
    <div class="col-lg-9 col-sm-8 col-md-8 col-xs-12">
        <ol class="breadcrumb">
            <li><a href="<?= base_url; ?>">Beranda</a></li>
            <li>Data Monitoring Persediaan</li>
            <li class="active">Data Mutasi Bahan Baku</li>
        </ol>
    </div>
</div>
...
<div class="row">
    <div class="col-md-12 col-lg-12 col-sm-12 col-xs-12">
        <div class="panel panel-default">
            <div class="panel-heading">Lihat Semua Data Mutasi Bahan Baku</div>
...
<!-- js list -->
<script type="text/javascript" src="<?= base_url."app/views/mutasi_bahan_baku/js/initList.js"; ?>"></script>