...
<div class="row bg-title">
    <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
        <h4 class="page-title">Lihat Detail Data Produk</h4>
    </div>
            ...
            <div class="user-bg">
                <div class="overlay-box">
                    <div class="user-content">
                        <a href="javascript:void(0)" data-effect="mfp-zoom-in"><img src="javascript:;" class="thumb-lg img-circle" alt="Foto Produk"/></a>
    ...
    <div class="col-md-8 col-xs-12">
        <div class="white-box">
        	<div class="sttabs tabs-style-linetriangle">
                <nav>
                    <ul>
                        <li><a href="#section-data-produk"><span>Data Produk</span></a></li>
                        <li><a href="#section-data-mutasi-produk"><span>Data Mutasi Produk</span></a></li>
                    </ul>
                </nav>
                    	...
                    	<div class="row">
                    		...
                    		<div class="col-md-6">
		                        ...
		                        <div class="form-group m-b-5">
		                            ...
		                            <p class="form-control-static" id="info_kd_produk">Info Produk</p>
								</div>
								<!-- nama -->
		                        <div class="form-group m-b-5">
									<label>Nama Produk:</label>
		                            <p class="form-control-static" id="info_nama">Info Nama Produk</p>
								</div>
								<!-- satuan -->
		                        <div class="form-group m-b-5">
									<label>Satuan:</label>
                    		...
                    		<div class="col-md-6">
		                        ...
		                        <div class="form-group m-b-5">
		                            ...
		                            <p class="form-control-static" id="info_komposisi">Info Komposisi</p>
								</div>
                    		</div>
                    	</div>	
                    </section>
                    <section id="section-data-mutasi-produk">
