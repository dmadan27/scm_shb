...
function getEdit(id){
    window.location.href = base_url+"index.php?m=perencanaan_bahan_baku&p=form&id="+id;
}

function getView(id){
    window.location.href = base_url+"index.php?m=perencanaan_bahan_baku&p=view&id="+id;
}
        ...
        $.ajax({
            ...
            success: function(output){
                ...
                if(output){
                    ...
                    $("#tabel_perencanaan_bahan_baku").DataTable().ajax.reload();
                }
            },
