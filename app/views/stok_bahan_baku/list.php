...
<div class="row bg-title">
    <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
        <h4 class="page-title">Data Stok Bahan Baku</h4>
    </div>
    <div class="col-lg-9 col-sm-8 col-md-8 col-xs-12">
        <ol class="breadcrumb">
            <li><a href="<?= base_url; ?>">Beranda</a></li>
            <li>Data Monitoring Persediaan</li>
            <li class="active">Data Stok Bahan Baku</li>
        </ol>
    </div>
</div>
            ...
            <div class="panel-wrapper collapse in">
                <div class="panel-wrapper collapse in">
                    <div class="panel-body">
                        ...
                        <table id="tabel_stok_bahan_baku" class="table table-hover dt-responsive nowrap" cellspacing="0" width="100%">
                            <thead>
                                <tr>
...
<!-- js list -->
<script type="text/javascript" src="<?= base_url."app/views/stok_bahan_baku/js/initList.js"; ?>"></script>